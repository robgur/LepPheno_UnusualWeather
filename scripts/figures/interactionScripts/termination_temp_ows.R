...
inla_mdf <- mdf_phylo %>% 
  dplyr::select(q95, annualTemp, annualPrec, dstdoy, voltinism, overwinteringStage,
...
pglmm1 <- pglmm(formula = q95 ~ annualTemp + annualPrec + 
                        dstdoy + 
...
pglmm4 <- pglmm(formula = q95 ~ annualTemp + annualPrec + 
                  dstdoy + 
                  voltinism + overwinteringStage + diurnality + Seas +
                  annualTemp:voltinism +
                  annualTemp:overwinteringStage +
...
pglmm5 <- pglmm(formula = q95 ~ annualTemp + annualPrec + 
                  dstdoy + 
                  voltinism + overwinteringStage + diurnality + Seas +
                  annualTemp:voltinism +
                  annualTemp:overwinteringStage +
